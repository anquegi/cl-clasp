...
(defpackage PORTABLE-DEFSYSTEM
	    ...
	    #-allegro (:nicknames #-Lispworks "DEFSYSTEM" "DEFSYS" "MAKE"))
...
#-(or allegro MCL harlequin-common-lisp) ; (Westy)
...
(defun internalize-direcotry (directory)
  (case (car directory)
