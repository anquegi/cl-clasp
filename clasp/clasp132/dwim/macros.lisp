...
(defmacro without-interrupts (&body body)
  ...
  ((:genera  `(scl::without-interrupts ,@body))
   ...
   ;; 11-2-93 Westy
   (:lispworks `(lispworks::without-interrupts ,@body))))
...
(defmacro handler-case (form &rest clauses)
  ...
  ((:genera `(future-common-lisp:handler-case ,form ,@clauses))
   ...
   ;; 11-2-93 Westy
   ((or :mcl lispworks) `(COMMON-LISP:handler-case ,form ,@clauses))))
...
(defmacro handler-bind (bindings &body forms)
  ...
  ((:genera `(future-common-lisp:handler-bind ,bindings ,@forms))
   ...
   ;; 11-2-93 Westy
   ((or :mcl :lispworks) `(COMMON-LISP:handler-bind ,bindings ,@forms))
   ))
...
(defmacro ignore-errors (&body body)
  ...
  ((:Allegro `(lisp:ignore-errors ,@body))
   ;; 11-2-93 Westy
   ((or :mcl :lispworks) `(COMMON-LISP:ignore-errors ,@body))   
  ...
  ((:allegro `(lisp:with-simple-restart (,name ,format-string ,@format-args) ,@body))
   ...
   (:genera
    `(future-common-lisp:with-simple-restart (,name ,format-string ,@format-args)
       ,@body))
   ;; 11-2-93 Westy
   ((or :mcl :lispworks) `(COMMON-LISP:with-simple-restart (,name ,format-string ,@format-args) ,@body))
   ))
...
(defmacro restart-case (expression &body clauses)
  ...
  ((:genera `(future-common-lisp:restart-case ,expression ,@clauses))
   ...
   ;; 11-2-93 Westy
   ((or :mcl :lispworks) `(COMMON-LISP:restart-case ,expression ,@clauses))))
...
(defun invoke-restart (restart &rest values)
  ...
  ((:genera (apply #'future-common-lisp:invoke-restart restart values))
   ...
   ;; 11-2-93 Westy
   ((or :mcl :lispworks) (apply #'COMMON-LISP:invoke-restart restart values))))
...
(defun find-restart (name &optional condition)
  ...
  ((:genera (future-common-lisp:find-restart name condition))
   ...
   ;; 11-2-93 Westy
   ((or :mcl :lispworks) (COMMON-LISP:find-restart name condition))))
