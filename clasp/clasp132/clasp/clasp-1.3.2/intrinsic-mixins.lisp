...
;;;; *-* File: Titanic: /usr/users/eksl/group-files/clasp/v3dev/intrinsic-mixins.lisp *-*
;;;; *-* Last-edit: Thursday, February 25, 1993  12:11:31; Edited-By: carlson *-* 
...
(defclass named-object-mixin ()
     ((name :initform nil :type symbol :initarg :name :reader name)
      (description :initform nil :initarg :description :accessor description))
  #-(OR MCL EXPLORER LUCID) (:metaclass named-class)
...
(defclass remember-instances ()
  ()
  #-(OR MCL EXPLORER LUCID) (:metaclass basic-class))
...
;;;----------------------------------------------------------------------------
;;; We need to know is how to kill efficiently.
...
(defmethod kill :around ((the-object t))
  (unless (gethash (name the-object) *killed-objects-table*)
    (call-next-method)
    (setf (gethash (name the-object) *killed-objects-table*) the-object)))
